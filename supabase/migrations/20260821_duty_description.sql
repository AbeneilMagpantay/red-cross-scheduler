-- Optional shared duty description for instructions and other information
-- volunteers should know before registering or attending.

BEGIN;

ALTER TABLE public.schedules
  ADD COLUMN IF NOT EXISTS duty_description TEXT;
